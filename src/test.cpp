...
void callBack(const Type& type)
{
    cout << type.getName() << " registered" << endl;
}

EXTMR_SETCALLBACK(callBack)
...
{    
    ...
    int i = 0;
    getClass("Dummy").getMethod("doNothingUseful").call(&d, Variant(i, Variant::Reference));
    ...
    d.a[2][2] = 50;
    cout << getClass("Dummy").getProperty("a").getData(&d).to<void*>() << endl;

...
${OBJECTDIR}/src/EXTMR/Exceptions/MembersExceptions.o: src/EXTMR/Exceptions/MembersExceptions.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/EXTMR/Exceptions/MembersExceptions.o src/EXTMR/Exceptions/MembersExceptions.cpp
...
${OBJECTDIR}/src/EXTMR/RefCaster.o: src/EXTMR/RefCaster.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/EXTMR
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/EXTMR/RefCaster.o src/EXTMR/RefCaster.cpp

${OBJECTDIR}/src/EXTMR/RefVariant.o: src/EXTMR/RefVariant.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/EXTMR
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/EXTMR/RefVariant.o src/EXTMR/RefVariant.cpp

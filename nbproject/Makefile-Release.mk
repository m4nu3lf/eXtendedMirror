...
${OBJECTDIR}/src/XM/Item.o: src/XM/Item.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/XM
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/XM/Item.o src/XM/Item.cpp
...
${OBJECTDIR}/src/XM/Register.o: src/XM/Register.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/XM
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/XM/Register.o src/XM/Register.cpp

${OBJECTDIR}/src/XM/SpecialMembers.o: src/XM/SpecialMembers.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/XM
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/XM/SpecialMembers.o src/XM/SpecialMembers.cpp
